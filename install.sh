...
wget --no-check-certificate https://http.kali.org/kali/pool/main/k/kali-archive-keyring/kali-archive-keyring_2024.1_all.deb || { echo "Failed to download keyring. Exiting."; exit 1; }
